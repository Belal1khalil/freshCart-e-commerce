...
export default function AccountLayout() {
  ...
  return (
    <section>
      <div className="max-w-screen-xl mx-auto px-3 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 py-8">

        {/* Sidebar */}
        <aside className="col-span-1 lg:col-span-3 w-full overflow-hidden">
          <div className="bg-white rounded-xl shadow p-5">
