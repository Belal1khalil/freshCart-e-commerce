...
//             <img
//               src={image}
//               className="w-[600px] h-[430px] object-cover rounded-lg  shadow-lg "
//               alt=""
//             />
...
//               Join thousands of happy customerswho trust FreshCart for their
//               <br></br>{" "}
//               <span className="text-center block">daily grocy needs</span>
//             </p>
...
//               <span className="absolute left-1/2 top-1/2 -translate-1/2 bg-white text-gray-300 text-sm line-clamp-1 ">
//                 OR CONTINUE WITH EMAIL
//               </span>
//             </div>
//             <form
//               className=" space-y-5 px-4 *:space-y-2  "
...
//             <div className="flex flex-wrap justify-center items-center gap-2 *:flex *:justify-center *:items-center *:gap-1 *:text-sm *:mb-2 *:text-gray-400">
//               <div>
