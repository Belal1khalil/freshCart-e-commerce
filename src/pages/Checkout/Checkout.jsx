...
//   return (
//     <>
//       <PageMetaData title="Checkout - Fresh Cart" description="Complete your purchase by providing payment and shipping details for your Fresh Cart order." />
//       <section>
...
//           >
//             {/* ========== Payment Method ========== */}
//             <div className="payment-metod lg:col-span-8">
...
//                       </div>
//                       {formik.values.paymentMethod === "cod" && (
//                         <div className="px-3 py-2 mt-4 ml-10 flex gap-2 items-center text-primary-600 justify-center border border-primary-600/50 rounded-md">
//                           <FontAwesomeIcon
//                             icon={faCircleInfo}
//                             className="p-2"
//                           />
...
//                       </div>
//                       {formik.values.paymentMethod === "online" && (
//                         <div className="px-3 py-2 mt-4 ml-10 flex gap-2 items-center text-blue-600 justify-center border border-blue-600/50 bg-blue-600/10 rounded-md">
//                           <FontAwesomeIcon
//                             icon={faCircleInfo}
//                             className="p-2"
//                           />
...
//                   {/* Phone */}
//                   <div className="phone flex flex-col gap-2 w-1/2">
...
//                   {/* City */}
//                   <div className="city flex flex-col gap-2 w-1/2">
...
//             {/* ========== Order Summary ========== */}
//             <div className="order-summery max-h-fit bg-white shadow-sm p-6 rounded-lg lg:col-span-4">
...
//                   <button
//                     type="submit"
//                     className="btn w-full bg-primary-600 hover:bg-primary-700 transition-colors duration-200 text-white py-2 rounded-md"
//                   >
//                     Proceed to Payment <FontAwesomeIcon icon={faArrowRight} />
//                   </button>
//                   <Link
//                     to="/cart"
//                     className="btn text-center w-full bg-transparent border border-gray-300 hover:border-primary-600 transition-colors duration-200 py-2 rounded-md"
//                   >
...
//                         <span className="text-primary-600 text-sm sm:text-base">Recommended</span>
//                       </div>
//                       {formik.values.paymentMethod === "online" && (
  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-gray-50 overflow-hidden">
        <div className="container max-w-6xl py-7 px-4 sm:px-6 h-full">
          <h1 className="text-2xl font-semibold mb-6 mx-3">Checkout</h1>
          <div className="h-[calc(100vh-140px)] lg:h-auto overflow-y-auto lg:overflow-visible">
            <form
              className="grid lg:grid-cols-12 gap-8 pb-8 lg:pb-0"
              onSubmit={formik.handleSubmit}
            >
              {/* ========== Payment Method ========== */}
              <div className="payment-method lg:col-span-8">
              ...
              {/* ========== Order Summary ========== */}
              <div className="order-summary max-h-fit bg-white shadow-sm p-4 sm:p-6 rounded-lg lg:col-span-4 lg:sticky lg:top-4">
                <h2 className="text-xl font-semibold mb-4">Order Summary</h2>
                <div className="space-y-3 cart-items max-h-48 overflow-auto p-3">
                  {products.map((product) => (
                    <div
